      ...
      <v-container>
        ...
        <v-layout row justify-center>
          <v-dialog v-model="startProjectDialog" max-width="600px" persistent>
            <v-btn slot="activator" color="primary" dark>Start Funding Your Project !</v-btn>
            <v-card>
              <v-card-title>
                <span class="headline font-weight-bold mt-2 ml-4">Start Collecting funds for your project!</span>
              </v-card-title>
              ...
              >
                <v-card-title primary-title>
                  <div>
                    ...
                    <br/><br/>
                    <small>Goal of <b>{{ project.goalAmount / 10**18 }} ETHO </b></small>
                    <small v-if="project.currentState == 1">wasn't achieved before the end of the deadline</small>
